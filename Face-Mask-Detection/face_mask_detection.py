...
st.beta_set_page_config(page_title="Le détecteur de masque)",page_icon="😷",layout="centered",initial_sidebar_state="auto",)
st.markdown("<h1 style='text-align: center ; color: black;'>Le détecteur de masque </h1>", unsafe_allow_html=True)

with open("style.css") as f:
    st.markdown('<style>{}</style>'.format(f.read()), unsafe_allow_html=True)

st.sidebar.header("Taux de précision")
...
if uploaded_file is not None:
    ...
    with st.beta_expander("Chargement de l'image"):
        st.image(image, channels="BGR")

    gif_path = '3193765139_1_4_T2FXNMCd.gif'
